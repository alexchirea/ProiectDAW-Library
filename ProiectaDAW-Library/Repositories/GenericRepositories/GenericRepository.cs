...
namespace ProiectaDAW_Library.Repositories.GenericRepositories
{
    public class GenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : class
    {
        protected readonly ProiectDawData _context;
        protected readonly DbSet<TEntity> _table;
        public GenericRepository(ProiectDawData dbContext)
        {
            _context = dbContext;
